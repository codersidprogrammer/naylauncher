...
class FontSizeGenerator extends BaseGenerator<Class> {
  @override
  ...
  FontSizeGenerator({required this.baseJsonData, required this.selectorField});
  ...
  Field generateField(String name, Map<String, String> value) {
    return Field(
      (f) => f
        ..name = name == 'DEFAULT' ? 'base' : 'text$name'
        ..static = true
        ..type = refer('double')
